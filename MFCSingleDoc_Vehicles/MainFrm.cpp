...
CMFCSingleDocVehiclesView* CMainFrame::GetRightPane()
{
...
void CMainFrame::OnUpdateViewStyles(CCmdUI* pCmdUI)
{
	...
	CMFCSingleDocVehiclesView* pView = GetRightPane();
...
void CMainFrame::OnViewStyle(UINT nCommandID)
{
	...
	// if the right-hand pane has been created and is a CMFCSingleDocVehiclesView,
